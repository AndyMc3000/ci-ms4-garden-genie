##### <br> #####
<a name="top-of-page">![Garden Genie Logo](/readme-assets/cpcp-logo-readme-header.png)</a>
# Garden Genie :four_leaf_clover: #
## An E-commerce web application dedicate dto all things Gardening ## 
### Purpose: Backend Development Project (Milestone Project 4) for the Diploma in Software Development course at [Code Institute](https://codeinstitute.net/) ###
### Developer: Andrew McDonald - Contact me on GitHub :octocat: @ <a href="https://github.com/AndyMc3000"><strong>AndyMc3000</strong></a> ###
### Website deployed on an Heroku App: [UPDATE ME](https://pool-club.herokuapp.com/) ###
<hr>
...
The Garden Genie Web Application (hereafter called GG) is my Milestone 3 (MS3) project for the Diploma in Fullstack Software Development course at Code Institute. 
